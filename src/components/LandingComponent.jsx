...
import { Cloud, Smartphone, Cpu, Home, Camera, Database, Menu, X } from 'lucide-react';
    ...
    <div ref={containerRef} className="relative min-h-screen bg-[#030712] overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            {/* Mobile Menu Button */}
<motion.button
  className="md:hidden text-cyan-400 relative z-50"  // Added z-50
...
>
  ...
  className="w-full h-full absolute"  // Added absolute
  style={{ zIndex: 1 }}  // Added z-index
  ref={svgRef}
>
